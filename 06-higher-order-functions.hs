...
higherOrderSequenceApplication :: (Int -> Int -> Int) -> Int -> Int -> Int
higherOrderSequenceApplication f a b = foldr1 (\acc x -> f x acc) [a..b]


-- Define a factorial method using the higherOrderSequenceAppliction
hoFactorial :: Int -> Int
hoFactorial = higherOrderSequenceApplication (*) 1